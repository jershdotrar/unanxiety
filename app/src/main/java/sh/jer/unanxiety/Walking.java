    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        minutes15.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                Intent i = new Intent(getApplicationContext(),Walking15.class);
                startActivity(i);
            }
        });
        ...
        minutes30.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                Intent i = new Intent(getApplicationContext(),Walking30.class);
                startActivity(i);
            }
        });
        ...
        minutes60.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                Intent i = new Intent(getApplicationContext(),Walking60.class);
                startActivity(i);
            }
        });
        ...
        minutes120.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                Intent i = new Intent(getApplicationContext(),Walking120.class);
                startActivity(i);
            }
        });
    }
